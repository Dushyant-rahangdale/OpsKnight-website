...
- The v1.3 application dependencies installed.
...
Do not use `npm run opsknight`; that npm script is not defined in v1.3.
...
| `npm run ops` missing      | Confirm the container/source checkout is OpsKnight v1.3 and includes `package.json` plus `scripts/OpsKnight.mjs`. |
