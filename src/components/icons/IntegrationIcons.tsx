...
export const integrationIcons = {
    ...
    jira: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
            ...
            <path d="M23.655 11.523h-11.226a.345.345 0 00-.345.345v11.366c0 .19.155.345.345.345h.217c6.27 0 11.354-5.084 11.354-11.354v-.357a.345.345 0 00-.345-.345z" fill="#ffffff" opacity="0.8" />
            <path d="M12.083.421a.345.345 0 00-.345.345v10.412a.345.345 0 00.345.345h11.226a.345.345 0 00.345-.345v-.357C23.654 5.551 18.57 .467 12.3.467h-.217z" fill="#ffffff" opacity="0.5" />
        </svg>
    ),
    pagerduty: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
