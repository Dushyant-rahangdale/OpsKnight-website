  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      <button
        ...
        className="group relative w-full flex items-center justify-between gap-2 px-3 py-2 rounded-xl bg-slate-800/50 border border-white/10 hover:border-blue-500/30 hover:bg-slate-800 transition-all text-sm"
      >
        {/* Glow on hover */}
        <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-xl blur opacity-0 group-hover:opacity-100 transition-opacity" />
